...
<?php
    ...
    if (mysqli_num_rows($querykategori) == 0) {
    	...
    	echo "<tr class='baris-title'>
    	          ...
    	          <th class='tengah' colspan='3'>Action</th>
    	       </tr>";
    ...
    while ($row=mysqli_fetch_assoc($querykategori)) {
    	echo "<tr>
                  ...
                  <td class='tombol-hapus'>
                      <a class='tombol-action' href='".BASE_URL."delete.php?id=".$row['kategori_id']."'>delete</a>
                  </td>
    	      </tr> "; 
